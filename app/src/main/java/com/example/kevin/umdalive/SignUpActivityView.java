 ...
 */
        ...
        if (emailText.indexOf('@') != -1) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry, this is not a valid emailEditText.", Toast.LENGTH_SHORT).show();
    ...
    public void setMajorSpinner(String mess) {
        this.major = mess;
    }

    public void setEmailEditText(String mess) {
        this.email = mess;
    }

    public void setPasswordEditText(String mess) {
        this.password = mess;
    }

    public void setUserName(String mess) {
        this.userName = mess;
    }
